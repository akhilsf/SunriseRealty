  ...
  const QAs = [
    ...
    },
    {
      ...
      answer:
        <ResponseList>
          <ResponseListItem>
            <u style={{color: 'white'}}>Cash Flow:</u> All properties that we invest in provide sufficient cash flow to serve as a hedge against unforeseen but inevitable expenses.
          </ResponseListItem>
          <ResponseListItem>
            <u style={{color: 'white'}}>Economies of Scale:</u> Relative to smaller rental property investments, per unit-operational costs are lower, which improves margins.
          </ResponseListItem>
          <ResponseListItem>
            <u style={{color: 'white'}}>Forced Appreciation:</u> Given we select apartments that are underperforming, we are able to force appreciation through improvements in net operating income, which directly drives commercial real estate valuation.
          </ResponseListItem>
          <ResponseListItem>
            <u style={{color: 'white'}}>Lower Vacancy Risk:</u> Large apartments are much less exposed to vacancy risk relative to smaller rental properties, given each unit is a much smaller percentage of the total number of units. For example, a vacant single family home yields no income; this is a near-impossible scenario for a large apartment.
          </ResponseListItem>
          <ResponseListItem>
            <u style={{color: 'white'}}>Macro Trends:</u> The U.S. is increasingly becoming a nation of renters, as fewer and fewer people are committing to purchasing their own homes.
          </ResponseListItem>
          <ResponseListItem>
            <u style={{color: 'white'}}>Market Resilience:</u> A roof to live under is a basic human need, unlike other forms of commercial real estate. Moreover, during recessions people often downsize into less-expensive apartments. This  is why Sunrise Realty Investments targets quality apartments with value-add potential versus turn-key, new-build apartments.
          </ResponseListItem>
          <ResponseListItem>
            <u style={{color: 'white'}}>Tax Benefits:</u> Due to their size, there is greater opportunity to benefit from depreciation strategies that ultimately improve investors' net income.
          </ResponseListItem>
        </ResponseList>
    },
    {
      question:
        <Response>
          If I invest with Sunrise Realty Investments, where is my money going? Am I investing in a fund that will be distributed across multiple properties or in a single asset?',
          answer: 'Investor funds go towards the property's down payment, closing costs, renovation costs, operating account funding, debt origination fee, and sponsor fees. Each investment with Sunrise Realty Investment is allocated to a single deal (i.e., not a fund).
        </Response>
      },
    {
    ...
    },
    {
      ...
      answer:
        <Response>
          Many syndicators charge a slew of fees to investors, including acquisition fees, asset management fees, refinancing fees, capital transaction fees, and many others. At Sunrise Realty Investments, we value alignment of interests, and therefore we only charge a nominal, market-parity acquisition fee and asset management fee. Furthermore, we only take profit splits and asset management fees <u style={{color: 'white'}}>after</u> investor return targets are met
        </Response>
    },
    {
