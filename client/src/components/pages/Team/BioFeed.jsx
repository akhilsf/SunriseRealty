  ...
  const bios = [
    {
      ...
      bio: 'Anish specializes in detailed market analysis, financial modeling, asset management, and investor relations. His expertise stems from his 15+ year support of his family hotel business, where he supports marketing and interior and exterior design activities; his 7+ year career within the biotechnology industry, where he guides company strategy through strategic partnerships, market analysis, financial modeling, and long-range planning; and his 5+ year, personal experience owning and operating rental properties. He is also a member of several mastermind and investor groups and the co-host of the Bay Area Multifamily Masters Meetup.',
    },
    {
      shortID: 'akash',
      name: 'Akash Patel',
